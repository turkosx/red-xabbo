...
public static class ViewModelLocator
{
    ...
    static void RegisterServices()
    {
        ...
        {
            Name = "redxabbo",
            Description = "enhanced habbo extension",
            Author = "@tur.ko",
        ...
        Splatr.RegisterLazySingleton<ILocalizationService, LocalizationService>();
    ...
    static void RegisterComponents()
    {
        ...
        Splatr.RegisterLazySingleton<SearchUsersComponent>();
