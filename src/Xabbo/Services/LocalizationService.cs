...
public sealed class LocalizationService : ReactiveObject, ILocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> _portugueseBrazil = new Dictionary<string, string>
    {
        ...
        ["inventory.empty.enterRoom"] = "Entre em um quarto para carregar o inventario",
        ["inventory.empty.noPhotos"] = "Nenhuma foto no inventario",
        ["inventory.status.loading"] = "Carregando...",
        ["inventory.status.offeringItems"] = "Oferecendo itens...",
        ["inventory.status.awaitingCornerSelection"] = "Clique nos 2 cantos da area onde voce quer posicionar os itens",
        ["inventory.status.placingFloorItems"] = "Posicionando itens de chao",
        ...
        ["inventory.dialog.placeIntervalHint"] = "Tente aumentar o intervalo de posicionamento de furni nas configuracoes.",
        ["inventory.dialog.noPlacement.title"] = "Sem local para posicionar",
        ["inventory.dialog.noPlacement.message"] = "Nao foi possivel encontrar um local valido para posicionar.",
        ["inventory.dialog.error.title"] = "Erro",
        ["inventory.dialog.warning.title"] = "Aviso",
        ["inventory.dialog.notTrading.message"] = "Voce nao esta em uma troca no momento.",
        ["inventory.dialog.offerIntervalHint"] = "Tente aumentar o intervalo de oferta nas configuracoes.",
        ["inventory.dialog.mustBeInRoom.message"] = "Voce precisa estar em um quarto para carregar seu inventario.",
        ["inventory.dialog.loadFailed.title"] = "Falha ao carregar inventario",
        ["inventory.operation.selectArea"] = "Selecionar area",
        ["inventory.operation.placeFurni"] = "Posicionar furni",
        ["inventory.operation.offerItems"] = "Oferecer itens",
        ["inventory.operation.loadInventory"] = "Carregar inventario",
        ["inventory.error.roomStateNotTracked"] = "O estado do quarto nao esta sendo rastreado.",
        ...
        ["info.credits"] = "Creditos",
        ["info.credits.note"] = "Referencias centrais do ecossistema xabbo.",
        ...
        ["info.credits.qdaves.title"] = "QDaves",
        ["info.credits.qdaves.description"] = "Contribuicoes para a comunidade Xabbo.",
        ["info.credits.forks.pill"] = "Open source",
        ["info.credits.forks.title"] = "Xabbo Forks",
        ["info.credits.forks.description"] = "Forks e derivados do repositorio Xabbo.",
        ...
        ["general.search.username"] = "Usuario",
        ["general.search.start"] = "Buscar",
        ["general.search.stop"] = "Parar",
        ["general.search.status"] = "Status",
        ["general.search.foundUser"] = "Usuario encontrado",
        ["general.search.foundRoom"] = "Quarto",
        ["general.search.status.idle"] = "Pronto para buscar.",
        ["general.search.status.unavailable"] = "A busca esta disponivel apenas em clientes modernos.",
        ["general.search.status.enterUser"] = "Digite um usuario para buscar.",
        ...
        ["general.search.status.found"] = "Usuario encontrado: {0} em {1}.",
        ["general.search.status.notFound"] = "Usuario '{0}' nao foi encontrado nos quartos disponiveis.",
