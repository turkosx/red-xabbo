...
public sealed class LocalizationService : ReactiveObject, ILocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> _english = new Dictionary<string, string>
    {
        ...
        ["general.clickTo.silenceToggle"] = "Silence toggle",
        ["general.clickTo.silenceToggleTip"] = "Click once to silence the user, click again to unsilence",
        ["general.clickTo.blockToggle"] = "Block toggle",
        ["general.clickTo.blockToggleTip"] = "Click once to block the user, click again to unblock",
        ...
        ["general.clickTo.info.silencing"] = "(click-silencing user)",
        ["general.clickTo.info.unsilencing"] = "(click-unsilencing user)",
        ["general.clickTo.info.blocking"] = "(click-blocking user)",
        ["general.clickTo.info.unblocking"] = "(click-unblocking user)",
        ["general.clickTo.info.blockUnavailable"] = "(click-block unavailable)",
        ["general.entry"] = "Entry",
    ...
    private static readonly IReadOnlyDictionary<string, string> _portugueseBrazil = new Dictionary<string, string>
    {
        ...
        ["general.clickTo.silenceToggle"] = "Calar/Ouvir Habbo",
        ["general.clickTo.silenceToggleTip"] = "1 clique para calar, outro clique para ouvir Habbo",
        ["general.clickTo.blockToggle"] = "Bloquear/Desbloquear",
        ["general.clickTo.blockToggleTip"] = "1 clique para bloquear, outro clique para desbloquear",
        ...
        ["general.clickTo.info.silencing"] = "(click-calando usuario)",
        ["general.clickTo.info.unsilencing"] = "(click-ouvindo habbo usuario)",
        ["general.clickTo.info.blocking"] = "(click-bloqueando usuario)",
        ["general.clickTo.info.unblocking"] = "(click-desbloqueando usuario)",
        ["general.clickTo.info.blockUnavailable"] = "(click-bloquear indisponivel)",
